  ...
  <div class="min-h-screen font-sans">
    ...
    <section class="relative pt-32 pb-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span class="text-primary font-semibold text-sm uppercase tracking-widest">Stay Informed</span>
        <h1 class="text-4xl lg:text-5xl font-black text-white mt-3 mb-4">News & Events</h1>
        <p class="text-gray-300 max-w-xl mx-auto">Stay up to date with the latest real estate news, market insights, and upcoming events from Sophor.</p>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-all group">
          <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="h-64 lg:h-auto bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center min-h-64">
              <i class="fas fa-city text-8xl text-primary/30 group-hover:scale-110 transition-transform duration-500"></i>
            </div>
    ...
    <section class="py-12 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="item in filteredNews" :key="item.title"
            ...
            <div class="h-48 bg-gradient-to-br flex items-center justify-center relative overflow-hidden"
              :class="item.gradient">
              <i :class="item.icon + ' text-5xl opacity-30 group-hover:scale-110 transition-transform duration-500'"></i>
