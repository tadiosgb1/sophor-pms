    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg text-sm overflow-hidden">
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="font-semibold text-gray-800">New Sale</h2>
            <p class="text-xs text-gray-400">Record a property sale transaction</p>
          </div>
        </div>
      ...
      <form @submit.prevent="submitForm" class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
        ...
        <div>
          ...
          <textarea v-model="form.notes" rows="2" placeholder="Optional notes about this sale…"
      ...
      <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
        ...
        <button @click="submitForm" :disabled="submitting || !form.status"
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        await this.$apiPost('/sale', this.form);
