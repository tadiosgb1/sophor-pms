module.exports = (sequelize, Sequelize) => {
  ...
  Sale.associate = (db) => {
    ...
    Sale.belongsTo(db.User, { foreignKey: "buyer_id" });
    Sale.belongsTo(db.User, { foreignKey: "owner_id" });
    Sale.belongsTo(db.User, { foreignKey: "created_by" });
    Sale.belongsTo(db.User, { foreignKey: "updated_by" });
  };
