module.exports = (sequelize, Sequelize) => {
  ...
  Site.associate = (db) => {
    ...
    Site.belongsTo(db.User, { foreignKey: "manager_id", as: "manager" });
    Site.belongsTo(db.User, { foreignKey: "staff_id", as: "staff" });
    Site.belongsTo(db.User, { foreignKey: "owner_id", as: "owner" });
    Site.belongsTo(db.User, { foreignKey: "created_by", as: "createdBy" });
    Site.belongsTo(db.User, { foreignKey: "updated_by", as: "updatedBy" });
